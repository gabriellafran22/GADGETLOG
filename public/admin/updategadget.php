...
<head>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 	...
 	<script type="text/javascript" src="js/addons/maps/world/world_mill.js"></script>
	<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet">
	  <script>
	    ...
	    function filtersel(range){
	    	document.location = 'updategadget.php?brands=' + range;
	    }
  </script>
</head>
<body>
	...
	<nav id="sidenav">
		...
		<div data-toggle="collapse" data-target="#gspecs" id="sidenavcomp" onclick="clicktoggle()">
			...
			<div class="collapse" id="gspecs">
				...
				<div style="border-bottom: 1px solid white;" onclick="window.open('updategadget.php','_self')">
...
<script src="updategadgetSearch.js"></script>
</body>
</html>
